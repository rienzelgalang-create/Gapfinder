...
# This module defines the create_model function to build the Bayesian Network for geometric figures.
...
GRAPH_PATH = str(BASE_DIR / "graphml" / "GeometricFiguresBN.graphml")
