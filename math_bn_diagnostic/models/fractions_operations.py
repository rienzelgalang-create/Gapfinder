...
# This module defines the create_model function to build the Bayesian Network for fractions operations.
...
GRAPH_PATH = str(BASE_DIR / "graphml" / "FractionsBN.graphml")
