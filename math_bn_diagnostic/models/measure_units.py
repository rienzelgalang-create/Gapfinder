# measure_units.py
# This module defines the create_model function to build the Bayesian Network for Measurement Units.
...
GRAPH_PATH = str(BASE_DIR / "graphml" / "MeasuresandUnitsBN.graphml")
